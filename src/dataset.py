...
class Interactions:
    ...
    def shuffle_interactions(self, random_state=None):
        ...
        return Interactions(
            self.user_ids[shuffle_indices],
            self.item_ids[shuffle_indices],
            ratings=index_or_none(self.ratings, shuffle_indices),
            timestamps=index_or_none(self.timestamps, shuffle_indices),
            weights=index_or_none(self.weights, shuffle_indices),
    ...
    def random_train_test_split(self, test_fraction=0.2, random_state=None):
        ...
        train = Interactions(
            ...
            ratings=index_or_none(interactions.ratings, train_idx),
            timestamps=index_or_none(interactions.timestamps, train_idx),
            weights=index_or_none(interactions.weights, train_idx),
        ...
        test = Interactions(
            ...
            ratings=index_or_none(interactions.ratings, test_idx),
            timestamps=index_or_none(interactions.timestamps, test_idx),
            weights=index_or_none(interactions.weights, test_idx),
            num_users=interactions.num_users,
            num_items=interactions.num_items,
        )
